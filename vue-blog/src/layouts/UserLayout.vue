  ...
  <header>
    <nav class="relative px-4 py-4 flex justify-between items-center bg-transparent">
      ...
      <div class="lg:hidden absolute right-2">
        ...
        <Sheet>
          <SheetTrigger as-child>
            <Button class=" items-center text-blue-600 p-3" variant="outline">
          ...
          <SheetContent :side="'left'">
            ...
            <div>
              ...
              <div class="mt-auto">
                <div class="pt-6">
                  <a class="block px-4 py-3 mb-3 leading-loose dark:text-black text-xs text-center font-semibold leading-none bg-gray-50 hover:bg-gray-100 rounded-xl"
                    href="#">Sign in</a>
                  <RouterLink :to="{name: 'signup'}" class="block px-4 py-3 mb-2 leading-loose text-xs text-center text-white font-semibold bg-blue-600 hover:bg-blue-700  rounded-xl"
                    >Sign Up</RouterLink>
                </div>
      ...
      <ul
        ...
        <div v-for="item in menu" class="flex justify-center align-middle">
          <li>
            <RouterLink
              :class="item.routePath === activeMenu ? ' text-blue-600 font-bold' : 'text-gray-400  hover:text-gray-500'"
              :to="{ name: item.routePath }" class="text-sm " href="#">{{ item.name }}
            </RouterLink>
          </li>
          <li class="text-gray-300 ml-3 mt-1">
        ...
        <!-- <li><RouterLink :to="{name: 'home'}" class="text-sm  text-blue-600 font-bold" href="#">Home</RouterLink></li>
			<li class="text-gray-300">
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill" viewBox="0 0 24 24">
					<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
				</svg>
			</li>
			<li><RouterLink :to="{name: 'about'}" class="text-sm  text-gray-400  hover:text-gray-500" href="#">About Us</RouterLink></li>
			<li class="text-gray-300">
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill" viewBox="0 0 24 24">
					<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
				</svg>
			...
			<li><a class="text-sm text-gray-400 hover:text-gray-500" href="#">Favorite</a></li>
			<li class="text-gray-300">
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill" viewBox="0 0 24 24">
					<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
				</svg>
